...
function App(){
  ...
  const getDifficultyBadge= (difficulty)=>{
    ...
    if(difficulty === 'Beginner'){
      return <span style={{ ...styles, backgroundColor: '#dcfce7', color: '#15803d' }}>Beginner</span>
    } else if (difficulty === 'Intermediate') {
      return <span style={{ ...styles, backgroundColor: '#fef9c3', color: '#a16207' }}>Intermediate</span>
    } else {
          ...
          <div style={{
            ...
            {projects.map(project => (
              <div
                key={project.id}
                style={{
                  backgroundColor: '#1e293b', // Modern dark card background
                  borderRadius: '16px',
                  padding: '2rem',
              ...
              <div>
                  ...
                  <h3 style={{ fontSize: '1.35rem', fontWeight: '700', marginBottom: '0.75rem', color: '#f8fafc' }}>
                    {project.title}
                  </h3>
                ...
                <button style={{
                  ...
                  borderRadius: '8px',
                  border: 'none',
                  backgroundColor: '#4f46e5', // Primary indigo button
                  color: '#ffffff',
                  fontWeight: '600',
                  fontSize: '0.95rem',
                  cursor: 'pointer',
                ...
                onClick={() => alert(`Starting quest: ${project.title}`)}
                >
                  Start Quest
                </button>
              </div>
